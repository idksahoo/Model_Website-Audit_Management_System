...
public class AuthorizationController {
	...
	public ResponseEntity<Boolean> validatingAuthorizationToken(@ApiParam(name = "JWT-token", value = "JWT generated for current customer present") @RequestHeader(name = "Authorization" ) String tokenDup) {
